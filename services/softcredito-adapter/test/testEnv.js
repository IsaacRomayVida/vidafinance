...
function setBaseEnv() {
  ...
  process.env.SOFTCREDITO_API_URL = 'https://sc.test/api';
  process.env.SOFTCREDITO_TOKEN_URL = 'https://sc.test/oauth/token';
  process.env.PAYMENT_SERVER_URL = 'https://payment-server.test';
  process.env.BUREAU_MODE = 'live';
