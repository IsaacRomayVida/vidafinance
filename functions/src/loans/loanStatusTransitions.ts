...
export const LOAN_APPROVAL_SOURCE_STATUSES = ['pending', 'under_review'];
...
export const DISBURSEMENT_INITIATED_STATUSES = [
  'disbursement_queued',
  'disbursement_failed',
  'active',
  'disbursed',
...
export const PRE_DISBURSEMENT_STATUSES = ['pending', 'under_review', 'approved'];
