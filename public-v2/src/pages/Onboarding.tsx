...
export function Onboarding() {
  ...
  const renderRoleSelection = () => (
    <div className="onb-content wide" style={{maxWidth:640,width:640,padding:"0 24px",boxSizing:"border-box"}}>
      <h1 className="onb-h">
  ...
  const renderEmployerSteps = () => (
    <>
      ...
      <div className={stageClass(1)}>
        {step === 1 && (
          <div className="onb-content" style={{maxWidth:520,width:520,padding:"0 24px",boxSizing:"border-box"}}>
