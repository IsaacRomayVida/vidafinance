    ...
    <div style={{ margin: '0 auto', maxWidth: 960, padding: '0 20px' }}>
      ...
      >
        <div style={{
          ...
          {isRejected ? (
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#dc503c" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <circle cx="12" cy="12" r="10"/><path d="M15 9l-6 6M9 9l6 6"/>
            </svg>
          ) : (
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#a28657" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
