      ...
      <div className="wrap">
        ...
        <div className="rv d3" style={{ marginBottom: 48, maxWidth: 1100, margin: '0 auto 48px', position: 'relative', overflow: 'hidden', borderRadius: 28 }}>
          <picture>
            ...
            <img loading="lazy" src="/images/worker-group.png" alt="Empleados usando VIDA"
              width={1000} height={545}
              style={{ width: '100%', height: 'auto', display: 'block', filter: 'drop-shadow(0 12px 32px rgba(25,68,69,0.08))' }}
            />
          </picture>
        </div>
